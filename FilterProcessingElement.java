...
class FilterProcessingElement {
    ...
    static void lengthFilter(List<Entry> entries, long Length, String Operator) {
      ...
      //Operator enum used for lengthFilter
        ...
        for(Entry entryy: entries) {
            if(entryy instanceof RemoteEntry entry){
                if(entryy.getName().contains(key)){
                    filteredNames.add((Entry) entry);
                }
